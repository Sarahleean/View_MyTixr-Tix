...
if (hotelRooms.length > 0) {
    const images = ['./images/hotel_Images/1.jpg', './images/hotel_Images/2.jpeg', './images/hotel_Images/3.jpeg', './images/hotel_Images/4.jpg'];
    ...
    function updateImage() {
        hotelRooms[0].style.backgroundImage = `url(${images[currentImageIndex]})`;
